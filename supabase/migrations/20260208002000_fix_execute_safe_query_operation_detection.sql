-- Fix operation detection in execute_safe_query.
-- Postgres regex does not treat \b as JavaScript-style word boundary.
-- Use [[:space:]] and \m/\M to avoid false operation_not_allowed for valid SELECTs.
